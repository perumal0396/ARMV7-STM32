...
void DMA_INIT(void)
{
	...
	*DMA1_S6CR   =  *DMA1_S6CR |(1<<4); //transmission complete interrupt enable	
...
void NVIC_CONFIG(void)
{
	...
	*NVIC_ICPR[0] = 1<<17;//clear the DMA1  channel6 interrupt flag
	
	*NVIC_ISER[0] = 1<<17;//enabling DMA1 interrupt channel6
