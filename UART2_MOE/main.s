...
USART2_GTPR:
	...
	.align	2
.LC0:
	.ascii	"USART_PRITING\012\015\000"
	.text
	.align	1
	.global	main
	.syntax unified
...
.L16:
	...
	nop
.L17:
	.loc 1 146 12 discriminator 1
	ldr	r3, .L18
	ldr	r3, [r3]
	ldr	r3, [r3]
	.loc 1 146 23 discriminator 1
	and	r3, r3, #64
...
.L18:
	...
	.cfi_endproc
.LFE4:
	.size	USART2_TX, .-USART2_TX
	.align	1
	.global	USART2_RX
	.syntax unified
	.thumb
	.thumb_func
	.type	USART2_RX, %function
USART2_RX:
.LFB5:
	.loc 1 153 1
	.cfi_startproc
...
.LFB7:
	...
	b	.L29
.L30:
	.loc 1 171 21 discriminator 3
	ldr	r3, [r7, #4]
	adds	r3, r3, #1
	str	r3, [r7, #4]
.L29:
	.loc 1 171 11 discriminator 1
	ldr	r3, [r7, #4]
	.loc 1 171 2 discriminator 1
	ldr	r2, .L31
	cmp	r3, r2
	bls	.L30
	.loc 1 172 1
...
.LASF52:
	.ascii	"/home/linux/Documents/STM/STM32F401CC/UART2_MOE\000"
.LASF50:
